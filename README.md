...
| `GPT_CODEX_HEARTBEAT_MS` | Discord proof-of-life animation refresh interval (default 5000) |
| `GPT_CODEX_HEARTBEAT_DELAY_MS` | Inactivity before the proof-of-life row first appears (default 60000) |
